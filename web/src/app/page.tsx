            ...
            <div className="setup-console">
              <div className="console-box">
                ...
                <div className="console-body">
                  ...
                  <div className="console-line success">✓ Distribution created: dist-packaged/Docksy Setup 1.0.0.exe</div>
                </div>

                <div className="download-bar">
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px" }}>
                    <span style={{ fontWeight: 600, fontSize: "0.8rem" }}>Docksy Setup 1.0.0.exe</span>
                    <span style={{ color: "#4c566a", fontSize: "0.7rem" }}>Windows x64 • ~45MB • MIT License</span>
                  </div>
                  <a
                    href="https://github.com/Mananwebdev160408/docksy/releases/latest/download/Docksy.Setup.1.0.0.exe"
